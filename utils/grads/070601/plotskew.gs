...
"define spd=mag(((uinterp+"um")),((vinterp+"vm")))"
"define dir=atan2(uinterp+"um",vinterp+"vm")*57.2957795+180.0"
...
If (DrawPrcl = 1)
   ...
   say 'LiftDry('Sfctemp','SfcPlev','PLcl',1,'_pmin','_pmax')'
   PTemp=LiftDry(Sfctemp,SfcPlev,PLcl,1,_pmin,_pmax)
   say 'LiftWet('TLcl','PLcl','_pmin',1,'_pmin','_pmax')'
